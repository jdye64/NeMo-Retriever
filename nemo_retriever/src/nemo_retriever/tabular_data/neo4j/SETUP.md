...
> **Warning — local Docker developer tooling.** The Compose commands in this guide run **Neo4j locally** for development only. This is **not** a supported production deployment path. For NeMo Retriever / NIM deployment, use the **[Docker service image](../../../../docker.md)** and the **[NeMo Retriever Library](https://docs.nvidia.com/nemo/retriever/latest/extraction/overview/)**.
